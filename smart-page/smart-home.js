...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // // funcion para mostrar los campos con información de cada celular
  // function showData() {
  
  //   // agarro todos los text a mostrar
  //   let cardTexts = document.querySelectorAll('#div-texts > .card-text');
  //   try { 
  //     for (let p = 0; p < cardTexts.length; p++) {
  // cardTexts.classList.toggle('hidden');
  // cardTexts.classList.toggle('show-card-text');
